      ...
      <div class="login-box">
        ...
        <div class="login-left">
          ...
          <div class="left-qrcode">
            <div id="qrcode" title="小鹿线"><canvas width="180" height="180" style="display: none;"></canvas><img src="../assets/img/er.png" style="display: block;"></div>
...
const userBtn = (formEl) => {
  ...
  if(ruleForm.username == test.name && ruleForm.userpwd == test.password && test.name !== '' && test.password !== '') {
    router.push({path:'/home'})
    alert('登陆成功')
  } else if(ruleForm.username !== '' && ruleForm.userpwd !== '' && ruleForm.username !== test.name && ruleForm.userpwd !== test.password) {
    alert('查无此号，暂未开通注册服务')
  }
}
</script>
